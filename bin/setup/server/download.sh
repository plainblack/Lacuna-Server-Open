...
#wget http://www.mysql.com/get/Downloads/MySQL-5.5/MySQL-client-5.5.8-1.rhel5.x86_64.rpm/from/http://mirror.services.wisc.edu/mysql/
#wget http://www.mysql.com/get/Downloads/MySQL-5.5/MySQL-devel-5.5.8-1.rhel5.x86_64.rpm/from/http://mirror.services.wisc.edu/mysql/
#wget http://www.mysql.com/get/Downloads/MySQL-5.5/MySQL-server-5.5.8-1.rhel5.x86_64.rpm/from/http://mirror.services.wisc.edu/mysql/
#wget http://www.mysql.com/get/Downloads/MySQL-5.5/MySQL-shared-5.5.8-1.rhel5.x86_64.rpm/from/http://mirror.services.wisc.edu/mysql/
