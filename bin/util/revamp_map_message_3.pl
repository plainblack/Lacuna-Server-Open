...
Early sensor data indicates that the energy ribbon did not in-fact destroy the Expanse, but rather evolved it. Many bodies have changed their very composition. In many ways this is an entirely new Expanse. While I'm sure that adventure seekers will love the opportunities for exploration, we reserve our opinion.
