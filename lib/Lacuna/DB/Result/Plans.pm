...
my $recipes = {
    ...
    'Lacuna::DB::Result::Building::Permanent::LibraryOfJith'        => [qw(chromite halite anthracite beryl)],
    ...
    'Lacuna::DB::Result::Building::Permanent::TerraformingPlatform' => [qw(methane zircon magnetite)],
