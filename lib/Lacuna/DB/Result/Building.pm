...
sub food_capacity {
    ...
    return 0 if $base == 0;
    return sprintf('%.0f', $base * ($self->storage_bonus + ($self->body->empire->farming_affinity * 3 / 100) ));
}
...
sub energy_capacity {
    ...
    return 0 if $base == 0;
    return sprintf('%.0f', $base * ($self->storage_bonus + ($self->body->empire->science_affinity * 3 / 100) ));
}
...
sub ore_capacity {
    ...
    return 0 if $base == 0;
    return sprintf('%.0f', $base * ($self->storage_bonus + ($self->body->empire->mining_affinity * 3 / 100) ));
}
...
sub water_capacity {
    ...
    return 0 if $base == 0;
    return sprintf('%.0f', $base * ($self->storage_bonus + ($self->body->empire->environmental_affinity * 3 / 100) ));
}
