...
sub time_cost_reduction_bonus {
    ...
    return (100 - $extra - ($body->empire->management_affinity * 5) + $unhappy_workers) / 100;
}
...
sub start_upgrade {
    ...
    my $time_to_add = $body->isa('Lacuna::DB::Result::Map::Body::Planet::Station') ? 60 * 60 * 100 : $cost->{time};
