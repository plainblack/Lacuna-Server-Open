package Lacuna::DB::Result::Building::PoliticsTraining;
...
use constant controller_class => 'Lacuna::RPC::Building::PoliticsTraining';

use constant max_instances_per_planet => 1;

use constant university_prereq => 15;

use constant image => 'politicstraining';

use constant name => 'Politics Training';
...
has spies_in_training_count => (
    ...
    default     => sub {
        my $self = shift;
        return $self->get_spies->search({task=>'Politics Training'})->count;
    },
);
