...
use constant chip_production => 900;
use constant pie_production => 900;
use constant shake_production => 900;
use constant soup_production => 900;
use constant syrup_production => 900;
