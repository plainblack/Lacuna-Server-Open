...
use constant energy_storage => 30000;
use constant water_storage => 30000;
use constant food_storage => 30000;
use constant ore_storage => 30000;
use constant waste_storage => 7500;
