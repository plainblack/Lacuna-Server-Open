...
sub credits {
    return [
            ...
            { 'Game Server'         => ['JT Smith','Graham Knop','Matthew Musgrove','Ian C. Docherty (icydee)', 'Mark Lemming (Norway)']},
            ...
            { 'Game Support'        => ['Plain Black Corporation / plainblack.com','Mary Hoerr']},
