...
sub colony_structures {
    return (
        ['Lacuna::DB::Result::Building::Permanent::EssentiaVein',28],
        ['Lacuna::DB::Result::Building::Permanent::GeoThermalVent',30],
        ['Lacuna::DB::Result::Building::Permanent::GratchsGauntlet',30],
        ...
        ['Lacuna::DB::Result::Building::Permanent::BeeldebanNest',30],
        ...
        ['Lacuna::DB::Result::Building::Permanent::MetalJunkArches',20],
        ['Lacuna::DB::Result::Building::Permanent::KalavianRuins',30],
        ...
        ['Lacuna::DB::Result::Building::Water::AtmosphericEvaporator',20],
        ['Lacuna::DB::Result::Building::SAW',30],
        ['Lacuna::DB::Result::Building::SAW',30],
        ['Lacuna::DB::Result::Building::SAW',30],
        ['Lacuna::DB::Result::Building::SAW',30],
        ['Lacuna::DB::Result::Building::SAW',30],
