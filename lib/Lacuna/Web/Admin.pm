...
ATTACKER:
    foreach my $attacker (@worst_attackers) {
        ...
        my $counter     = defined $attack{$attacker} ? $attack{$attacker} : {attack_victories=>0, defense_victories=>0, attack_spy_hours=>0, weight=>0};
        ...
        $out .= "<td>".$counter{$attacker}{attack_victories}."</td><td>".$counter{$attacker}{defense_victories}."</td>";
