...
The Mercenaries Guild is accessible via the URL C</mercenariesguild>. It allows you to send spies to other players via spy pods. Due to the vast distance of space, you may only trade with other players in your zone. It costs essentia to use it.
...
A hash reference containing the item you wish to trade. There is one type of item that can be traded via this mechanism: spies.
...
The hash reference for spiess looks like:
