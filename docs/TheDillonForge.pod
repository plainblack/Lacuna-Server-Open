...
=head2 split_plan ( session_id, building_id, plan_class, level, extra_build_level )
...
Will spend 2 essentia to complete the current task immediately. Returns B<view>
