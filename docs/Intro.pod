...
Starting in Version 4.000 of the server code, named arguments have been introduced. The use of positional
...
This method is no longer supported. It is shown in case you have any scripts which need
to be modified and for comparison with the following.
...
Parameters are named and can be in any order,
...
This has been discontinued due to ambiguity of dates such as 7th Apr 2013 which was previously "04 07 2013" and in most parts of
the world would be interpreted as 4th July 2013.
