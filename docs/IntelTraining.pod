...
The Intel Training Facility is where you build and control your spies.
...
Allows you to train an idle spy in the ways of intelligence gathering.

The trained spy will receive 1 intel per level of the building.
...
The unique id of the Intel Training Facility.
