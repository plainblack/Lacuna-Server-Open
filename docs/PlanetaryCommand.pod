...
=head2 view_freebies ( session_id, building_id )

Freebies are buildings you can build for free. You can get them from contests, tutorials, and from spy missions. You can only have one freebie of each building type at once. And you can only have 10 freebies queued up at once. You must either spend them, or lose them.
