...
Displays a list of the messages in the empire's inbox. Displays 25 messages per page.
...
A comma separated string of empire names. B<NOTE:> You may want to expose a search option here using L<Empire/"find">.
