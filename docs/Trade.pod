...
You can set up three supply-chains for each level of your Trade Ministry. Each 
supply-chain can transfer any amount of any one resource (food type, ore type
...
=head2 create_supply_chain (session_id, building_id, resource_type, resource_hour)
