...
=head2 view_waste_pushes ( session_id, building_id )

Returns a list of the waste pushes currently controlled by this Trade Ministry
...
There will usually only be one waste-push in action, to your local star.
