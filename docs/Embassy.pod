...
The id of the proposition you are casting this vote for or against. See C<view_propositions> for a list.
...
lower (by 25%) its broadcast power on other stars.
...
The unique id of a mining platform. See C<get_mining_platforms_for_star_in_jurisdiction>.
