...
=head3 withdraw_invite ( session_id, building_id, invite_id, [ message ] )
...
=head3 accept_invite ( session_id, building_id, invite_id, [ message ] )
...
=head3 reject_invite ( session_id, building_id, invite_id, [ message ] )
...
=head3 get_pending_invites ( session_id, building_id )
...
=head3 get_my_invites ( session_id, building_id )
...
=head3 assign_alliance_leader ( session_id, building_id, new_leader_id )
