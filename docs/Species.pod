...
Creates a species and then returns the id of the new species.

Throws 1000, 1005, 1007, and 1008.

=head3 params

A hash of parameters. With the exception of name and description, the parameters are all integers. When added together they must equal 45. 
...
=head4 construction_affinity

An integer between 1 and 7 inclusive, where 7 is best. Determines species advantages in constructing new buildings and destroying old buildings.
...
An integer between 1 and 7 inclusive, where 7 is best. Determines species advantages in upgrading existing buildings.
