...
The C<message_id> refers to a message in the L<Inbox>. Providing this ID allows you to pop open the inbox to a specific message to display to the user. The message will tell you what the results of the mission were if any. Not all missions will provide a message_id.
