...
=head2 name_spies ( { session_id: session_id, building_id: building_id, prefix: "p", suffix: "s", rename_null_only: bool } )
...
Returns C<view_all_spies> plus a C<renamed> key with the count of spies renamed.
...
=item Mayhem Training

Train in Mayhem skill

=item Politics Training
