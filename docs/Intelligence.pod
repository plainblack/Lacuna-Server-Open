...
Gather information about what is happening on this planet. On your own planets it will help you find out who's spying on you and what they're doing. On foreign planets it will give you information about the economy, infrastructure, and strength of that planet.
...
Attempt to destroy things on the planet.

=item Appropriate Technology

Attempt to steal ships, buildings, and possibly resources.

=item Incite Rebellion

Attempt to deplete happiness, turn spies, and otherwise cause chaos amongst the population.

=item Hack Networks

Attempt to destroy or control probes, and spread misinformation through Network 19.
