...
=head2 alliance_rank ( session_id, [ sort_by, page_number ] )
...
An attribute to sort by. Defaults to C<average_empire_size_rank>. Possible values are: C<average_empire_size_rank>, C<offense_success_rate_rank>, C<defense_success_rate_rank>, and C<dirtiest_rank>
...
=head2 find_alliance_rank ( session_id, sort_by, alliance_name )

Search for a particular alliance in the C<alliance_rank()>. Returns:
...
The field to sort by. See C<alliance_rank> for details.
...
An attribute to sort by. Defaults to C<empire_size_rank>. Possible values are: C<empire_size_rank>, C<offense_success_rate_rank>, C<defense_success_rate_rank>, and C<dirtiest_rank>
...
=head2 colony_rank ( session_id, [ sort_by ] )
...
=head2 spy_rank ( session_id, [ sort_by ] )
...
=head2 weekly_medal_winners ( session_id )
