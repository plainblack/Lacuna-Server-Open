...
A complete overview of the server statistics is available from B<http://servername.lacunaexpanse.com/server_overview.json>. 
...
=head2 find_empire_rank ( session_id, sort_by, spy_name )
