...
This method is extended to include the list of tasks.

 {
    ...
    "tasks" : [
       {
          "fail_chance" : 15,  #Note, range is not factored in.
          "min_level" : 10,
          "name" : "Make Asteroid",
          "occupied" : 0,
          "recovery" : 129600,
...
Can convert any non-inhabited asteroid (no platforms) to a random planet.  Initial size is determined by level of BHG. Usable at Black Hole Generator level 15.
