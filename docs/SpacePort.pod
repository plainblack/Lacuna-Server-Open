...
=head2 view_all_ships ( session_id, building_id, page_number )
...
Travelling ships will have a from and to block. Defending fighters will have a from and defending block.
