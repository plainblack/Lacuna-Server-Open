...
Optional. An integer specifying the speed at which all ships in the fleet should travel. An exception will be thrown if this exceeds the speed of the slowest ship in the fleet.
