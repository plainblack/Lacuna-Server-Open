...
=head2 recall_spies ( session_id, building_id, ship_id )

Recalls an orbiting Spy Shuttle ('Orbiting' task) and fetches all idle spies from the body it is orbiting to the body of origin.
