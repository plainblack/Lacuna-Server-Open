=head1 TheftTraining Methods

Theft Training Facility is accessible via the URL C</thefttraining>.
...
Allows you to train an idle spy in the art of appropriation.

The trained spy will receive 1 theft per level of the building.
