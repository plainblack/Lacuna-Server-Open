...
alter table alliance_log add column influence_rank int(11) notnull default '0';
alter table alliance_log add index idx_population_rank (population_rank);
alter table alliance_log add index idx_space_station_count_rank space_statuon_count_rank);
